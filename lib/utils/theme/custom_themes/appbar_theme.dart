...
class TAppBarTheme{
  ...
  static const lightAppBarTheme = AppBarTheme(
    ...
    iconTheme: IconThemeData(color: TColors.black, size: TSizes.md),
    actionsIconTheme: IconThemeData(color: TColors.black, size: TSizes.md),
  ...
  static const darkAppBarTheme = AppBarTheme(
      ...
      surfaceTintColor: Colors.transparent,
      iconTheme: IconThemeData(color: TColors.black, size: TSizes.md),
      actionsIconTheme: IconThemeData(color: TColors.white, size: TSizes.md),
